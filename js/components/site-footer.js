...
<footer class="prem-footer">
  ...
  <div class="prem-footer-top">
    ...
    <div class="pf-brand">
      <a href="${depth}/index.html" class="logo pf-logo-link" aria-label="AdiRaj Routes &amp; Reflections — home">
        <img src="${depth}/assets/AdiRaj.png" alt="AdiRaj Routes &amp; Reflections" class="site-logo-img site-logo-footer"/>
      </a>
      <div class="pf-brand-quote" aria-label="Site motto">
        <span class="pf-bq-caps">Slow travel. Honest stories.</span>
        <span class="pf-bq-italic">and the meaning we carry forward.</span>
      </div>
      <div class="pf-social">
        <a href="https://www.instagram.com/adiraj.routesandreflections/" class="pf-social-link" aria-label="Follow on Instagram" target="_blank" rel="noopener">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="url(#ig-grad-footer)" stroke-width="1.6" aria-hidden="true">
            <defs>
        ...
        <a href="https://in.pinterest.com/adirajroutesandreflections/" class="pf-social-link" aria-label="Follow on Pinterest" target="_blank" rel="noopener">
          <svg width="17" height="17" viewBox="0 0 24 24" fill="#E60023" aria-hidden="true">
    ...
    <div class="pf-newsletter">
      <p class="pf-col-title">Join the Journey</p>
      <p class="pf-newsletter-desc">New stories and quiet reflections — delivered only when it matters.</p>
